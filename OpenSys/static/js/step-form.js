...
$("#msform .previous").click(function(){
    ...
    $("#progressbar li").eq($("fieldset").index(previous_fs)).addClass("inProgress");
    $("#progressbar li").eq($("fieldset").index(previous_fs)).removeClass("checked");
    
    //$("li.item-ii" ).find(".checked").css( "background-color", "red" );
    //$("#progressbar li:first-child").eq($("fieldset").index(current_fs)).find(".checked").addClass("inProgress");
